...
<img src="./readm_img/shift.png" width = 500> <img src="./readm_img/3x3.png" width = 500>
...
- activate Image packaging configuration -> root file system type -> Ext4(SD)
- write "zedboard" in Yocto settings -> Yocto board settings -> yocto borad name -> "zedboard"
- run petalinux-config -x u-boot

- run petalinux-config -c kernel
##### video class 
- enter in Device drivers -> USB support and activate the following stuff
- USB support
...
- enter in Device drivers -> USB support -> USB Gadget Support and activate USB Gadget functions configurable through configfs (M)
- activate the following stuff
- Network control model
- Mass Storage
- USB webcam function
- enter USB precomposed configurations
activate:
- Gadget Zero (M)
- Network control model
- Mass storage (M)
- Multifunction composit gadget (M)
- activate RNDIS + CDC serial + storage configuration
- activate CDC ethernet + CDC serial + Storage configuration
- activate USB Webcam Gadget (M)

- activate Device Drivers -> Multimedia Support  -> Media Core Support -> Video4linux core and -> Media control API

- activate Device Drivers -> Multimedia Support -> video4linux options -> V4l2 sub-device userspace API
- activate Device Drivers -> Multimedia Support -> media drivers -> media USB adapters -> USB video Class (M) and UVC input events device support
- activate Device Drivers -> Multimedia Support -> media drivers -> media USB adapters -> V4l platform devices
...
- activate  Filesystem Packages  → x11  → base  → xserver-xorg
- activate  Filesystem Packages  → x11  → base  → xserver-xorg
- activate  Filesystem Packages  → x11  → wm  → matchbox-desktop
- activate  Filesystem Packages  → x11  → wm  → matchbox-wm
- activate Petalinux Package Groups → packagegroup-petalinux-opencv -> all options
- activate Petalinux Package Groups → packagegroup-petalinux-v4lutils -> all options
- activate Petalinux Package Groups → packagegroup-petalinux-x11 -> all options

<!-- - trovi i file sotto la cartella <project path>/images/linux e segui istruzioni getting started -->
